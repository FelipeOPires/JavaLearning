...
public class MetodosnextIntEnextDouble {
    ...
    Esse método faz a leitura de um único número, por exemplo, 58, ou 958.
    Mas quando digitamos os inputs, além do valor que deve ser lido, também apertamos enter, o que gera um caracter "\n" no buffer de entrada (fila de coisas que devem ser lidas),
    ...
    Depois disso, "Qual o seu nome?" é impresso, e o método nextLine() vai ler tudo que estiver no buffer de entrada até encontrar um "\n".
